...
`+i.raw,c.text+=`
`+i.raw,this.inlineQueue[this.inlineQueue.length-1].src=c.text);else if(i=this.tokenizer.table(t))t=t.substring(i.raw.length),n.push(i);else if(i=this.tokenizer.lheading(t))t=t.substring(i.raw.length),n.push(i);else{if(u=t,this.options.extensions&&this.options.extensions.startBlock){let w=1/0;const A=t.slice(1);let S;this.options.extensions.startBlock.forEach(function(T){S=T.call({lexer:this},A),typeof S=="number"&&S>=0&&(w=Math.min(w,S))}),w<1/0&&w>=0&&(u=t.substring(0,w+1))}if(this.state.top&&(i=this.tokenizer.paragraph(u)))c=n[n.length-1],g&&c.type==="paragraph"?(c.raw+=`
`+i.raw,c.text+=`
...
`+i.raw,c.text+=`
`+i.text,this.inlineQueue.pop(),this.inlineQueue[this.inlineQueue.length-1].src=c.text):n.push(i);else if(t){const w="Infinite loop on byte: "+t.charCodeAt(0);if(this.options.silent){console.error(w);break}throw new Error(w)}}return this.state.top=!0,n}inline(t,n){this.inlineQueue.push({src:t,tokens:n})}inlineTokens(t,n=[]){let i,c,u,g,w,A,S=t;if(this.tokens.links){const T=Object.keys(this.tokens.links);if(T.length>0)for(;(g=this.tokenizer.rules.inline.reflinkSearch.exec(S))!=null;)T.includes(g[0].slice(g[0].lastIndexOf("[")+1,-1))&&(S=S.slice(0,g.index)+"["+ot("a",g[0].length-2)+"]"+S.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex))}for(;(g=this.tokenizer.rules.inline.blockSkip.exec(S))!=null;)S=S.slice(0,g.index)+"["+ot("a",g[0].length-2)+"]"+S.slice(this.tokenizer.rules.inline.blockSkip.lastIndex);for(;(g=this.tokenizer.rules.inline.escapedEmSt.exec(S))!=null;)S=S.slice(0,g.index)+"++"+S.slice(this.tokenizer.rules.inline.escapedEmSt.lastIndex);for(;t;)if(w||(A=""),w=!1,!(this.options.extensions&&this.options.extensions.inline&&this.options.extensions.inline.some(T=>!!(i=T.call({lexer:this},t,n))&&(t=t.substring(i.raw.length),n.push(i),!0))))if(i=this.tokenizer.escape(t))t=t.substring(i.raw.length),n.push(i);else if(i=this.tokenizer.tag(t))t=t.substring(i.raw.length),c=n[n.length-1],c&&i.type==="text"&&c.type==="text"?(c.raw+=i.raw,c.text+=i.text):n.push(i);else if(i=this.tokenizer.link(t))t=t.substring(i.raw.length),n.push(i);else if(i=this.tokenizer.reflink(t,this.tokens.links))t=t.substring(i.raw.length),c=n[n.length-1],c&&i.type==="text"&&c.type==="text"?(c.raw+=i.raw,c.text+=i.text):n.push(i);else if(i=this.tokenizer.emStrong(t,S,A))t=t.substring(i.raw.length),n.push(i);else if(i=this.tokenizer.codespan(t))t=t.substring(i.raw.length),n.push(i);else if(i=this.tokenizer.br(t))t=t.substring(i.raw.length),n.push(i);else if(i=this.tokenizer.del(t))t=t.substring(i.raw.length),n.push(i);else if(i=this.tokenizer.autolink(t,ft))t=t.substring(i.raw.length),n.push(i);else if(this.state.inLink||!(i=this.tokenizer.url(t,ft))){if(u=t,this.options.extensions&&this.options.extensions.startInline){let T=1/0;const R=t.slice(1);let P;this.options.extensions.startInline.forEach(function(q){P=q.call({lexer:this},R),typeof P=="number"&&P>=0&&(T=Math.min(T,P))}),T<1/0&&T>=0&&(u=t.substring(0,T+1))}if(i=this.tokenizer.inlineText(u,kt))t=t.substring(i.raw.length),i.raw.slice(-1)!=="_"&&(A=i.raw.slice(-1)),w=!0,c=n[n.length-1],c&&c.type==="text"?(c.raw+=i.raw,c.text+=i.text):n.push(i);else if(t){const T="Infinite loop on byte: "+t.charCodeAt(0);if(this.options.silent){console.error(T);break}throw new Error(T)}}else t=t.substring(i.raw.length),n.push(i);return n}}class et{constructor(t){this.options=t||l}code(t,n,i){const c=(n||"").match(/\S*/)[0];if(this.options.highlight){const u=this.options.highlight(t,c);u!=null&&u!==t&&(i=!0,t=u)}return t=t.replace(/\n$/,"")+`
...
</html>`),!a)return void alert("Speaker view popup failed to open. Please make sure popups are allowed and reopen the speaker view.");(function(){const c=o.getConfig().url,u=typeof c=="string"?c:window.location.protocol+"//"+window.location.host+window.location.pathname+window.location.search;M=setInterval(function(){a.postMessage(JSON.stringify({namespace:"reveal-notes",type:"connect",state:o.getState(),url:u}),"*")},500),window.addEventListener("message",n)})()}}function t(c){let u=o.getCurrentSlide(),g=u.querySelectorAll("aside.notes"),w=u.querySelector(".current-fragment"),A={namespace:"reveal-notes",type:"state",notes:"",markdown:!1,whitespace:"normal",state:o.getState()};if(u.hasAttribute("data-notes")&&(A.notes=u.getAttribute("data-notes"),A.whitespace="pre-wrap"),w){let S=w.querySelector("aside.notes");S?(A.notes=S.innerHTML,A.markdown=typeof S.getAttribute("data-markdown")=="string",g=null):w.hasAttribute("data-notes")&&(A.notes=w.getAttribute("data-notes"),A.whitespace="pre-wrap",g=null)}g&&(A.notes=Array.from(g).map(S=>S.innerHTML).join(`
`),A.markdown=g[0]&&typeof g[0].getAttribute("data-markdown")=="string"),a.postMessage(JSON.stringify(A),"*")}function n(c){if(function(u){try{return window.location.origin===u.source.location.origin}catch{return!1}}(c)){let u=JSON.parse(c.data);u&&u.namespace==="reveal-notes"&&u.type==="connected"?(clearInterval(M),i()):u&&u.namespace==="reveal-notes"&&u.type==="call"&&function(g,w,A){let S=o[g].apply(o,w);a.postMessage(JSON.stringify({namespace:"reveal-notes",type:"return",result:S,callId:A}),"*")}(u.methodName,u.arguments,u.callId)}}function i(){o.on("slidechanged",t),o.on("fragmentshown",t),o.on("fragmenthidden",t),o.on("overviewhidden",t),o.on("overviewshown",t),o.on("paused",t),o.on("resumed",t),t()}return{id:"notes",init:function(c){o=c,/receiver/i.test(window.location.search)||(window.location.search.match(/(\?|\&)notes/gi)!==null?s():window.addEventListener("message",u=>{if(!a&&typeof u.data=="string"){let w;try{w=JSON.parse(u.data)}catch{}w&&w.namespace==="reveal-notes"&&w.type==="heartbeat"&&(g=u.source,a&&!a.closed?a.focus():(a=g,window.addEventListener("message",n),i()))}var g}),o.addKeyBinding({keyCode:83,key:"S",description:"Speaker notes view"},function(){s()}))},open:s}}})})(En);const Rn=ae;let Ln=new Ct({plugins:[An,Rn]});Ln.initialize({progress:!1,controls:!0,hashOneBasedIndex:!0,hash:!0,history:!0});
